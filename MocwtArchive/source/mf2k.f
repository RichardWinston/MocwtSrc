...
C     MOlcvkaDFLOW-96 documented in:
...
C         GWT BETA VERSION 2.5 BETA 4/14/2006 -  1.9 standard release, plus weighting
C         GWT BETA VERSION 2.7 BETA 5/4/2007 -  1.9.6 standard release, plus weighting
C         GWT BETA VERSION 2.8 BETA 3/20/2008 -  minor fixes
C     ******************************************************************
C        SPECIFICATIONS:
C     ------------------------------------------------------------------
...
CGWT
     ...
     2           'BFLX', 'CBDY', 'SSTR', 'MNWO', 'PCT ', 'GAM0', 'GAM1',
     3           'MEAN', 'PTOB', 'PRTP', 'CCBD', 'MBRP', 'MBIT', 'VBAL',
     4           '    ', '    ', '    ', '    ', '    ', '    ', '    ',
     5           '    ', '    ', '    ', '    ', '    ', '    ', '    ',
     6           '    ', '    ', '    ', '    ', '    ', '    ', '    ',
     &           '    ', 50*'    '/
...
cgzh debug (only read once, not each SP.  MNW Sites checked each SP)
     ...
     *                  IOUTS,JUNIT(18),
     *                  RZ(LCWEL2),MNWSITE,mxwel2,nwell2,
     &                  RX(LSMNWO))

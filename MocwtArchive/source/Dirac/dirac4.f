...
105   FORMAT(8A10)
110   FORMAT(8F10.0)
201   FORMAT(/////1H ,29X,'ANALYTICAL SOLUTION TO THE THREE-DIMENSIONAL'
     1 /1H ,28X,'ADVECTIVE-DISPERSIVE SOLUTE TRANSPORT EQUATION'/
     2 1H ,34X,'FOR AN AQUIFER OF INFINITE EXTENT'/
     3 1H ,30X,'WITH A CONTINUOUS POINT SOURCE AT XC,YC,ZC'
     3 1H ,30X,'WITH A DIRAC INITIAL CONDITION AT XC,YC,ZC'
     4 ///1H0,40X,'INPUT DATA'/1H ,40X,10(1H-))
...
210   FORMAT(1H0,25X,'SOLUTE MASS IN SOLUTION (D0) =',
     1 1P1E13.6,1X,A10/1H ,25X,
     2 'GROUND-WATER VELOCITY IN X-DIRECTION (VX) =',1P1E13.6,1X,A10/
     2 1H ,25X,'GROUND-WATER VELOCITY IN Y-DIRECTION (VY) =',1P1E13.6/
     2 1H ,25X,'GROUND-WATER VELOCITY IN Z-DIRECTION (VZ) =',1P1E13.6/
     4 1H ,25X,'DISPERSIVITY IN THE LONGITUDINAL DIRECTION',
     *  ' (ALPHAL) =',1P1E13.6,1X,A10/
     4 1H ,25X,'DISPERSIVITY IN THE TRANSVERSE DIRECTION',
     *  ' (ALPHAT) =',1P1E13.6,1X,A10/
     6 1H ,25X,'FIRST-ORDER SOLUTE DECAY RATE (DK) =',1P1E13.6,1X,A10)
212   FORMAT(1H0,25X,'AQUIFER IS OF INFINITE EXTENT'
     2 /1H0,25X,'CONTINUOUS POINT SOURCE IS AT X =',1P1E13.6,1X,A10/
     3 1H ,55X,'Y =',1P1E13.6,1X,A10/1H ,55X,'Z =',1P1E13.6,1X,A10/
     6 1H ,25X,'AQUIFER POROSITY (POR) =',1P1E13.6)
215   FORMAT(1H0,25X,'X-COORDINATES AT WHICH SOLUTE CONCENTRATIONS ',
     1 'WILL BE CALCULATED, IN ',A10/1H ,25X,78(1H-)/)
216   FORMAT(1H0,25X,'Y-COORDINATES AT WHICH SOLUTE CONCENTRATIONS ',
     1 'WILL BE CALCULATED, IN ',A10/1H ,25X,78(1H-)/)
217   FORMAT(1H0,25X,'Z-COORDINATES AT WHICH SOLUTE CONCENTRATIONS ',
     1 'WILL BE CALCULATED, IN ',A10/1H ,25X,78(1H-)/)
220   FORMAT(1H ,5X,8F12.4)
225   FORMAT(1H0,25X,'TIMES AT WHICH SOLUTE CONCENTRATIONS '
     1 'WILL BE CALCULATED, IN ',A10/1H ,25X,70(1H-)/)
230   FORMAT(1H1/1H0,15X,'SOLUTE CONCENTRATION AT TIME =',
     1 F12.4,1X,A10/1H ,35X,'AND AT Z =',F12.4,1X,A10/
     2 1H0,25X,'Y-COORDINATE, IN ',A10)
231   FORMAT(1H1/1H0,15X,'SOLUTE CONCENTRATION AT TIME =',
     1 F12.4,1X,A10,5X,'(CONTINUED)'/1H ,35X,'AND AT Z =',F12.4,1X,A10/
     2 1H0,25X,'Y-COORDINATE, IN ',A10)
235   FORMAT(1H ,20X,9F12.4)
236   FORMAT(1H ,19X,'*',108(1H-)/
     1 1H ,4X,'X-COORDINATE,',2X,'!',44X,'SOLUTE CONCENTRATION, IN '
     2 A10/1H ,4X,'IN ',A10,2X,1H!/1H ,19X,'!')
240   FORMAT(1H ,5X,F12.4,2X,'!',1P9E12.4)
241   FORMAT(1H ,19X,'!')
      END
...
C       FORMAT STATEMENTS
101   FORMAT (A60)
201   FORMAT(1H1//////////1H ,16X,68(1H*))
202   FORMAT(1H ,16X,1H*,66X,1H*/1H ,16X,1H*,3X,60A1,3X,1H*)
203   FORMAT(1H ,16X,1H*,66X,1H*/1H ,16X,1H*,12X,'PROGRAM RUN ON ',
     1 A16,' AT ',A8,11X,1H*/1H ,16X,1H*,66X,1H*/1H ,16X,68(1H*)
     2 /1H1)
      END
C
C       ******************************************************

...
c     ------------------------------------------------------------------
      IMPLICIT NONE
      INTEGER MNWOBS,IOUT,IOB,IS_SITE,INMNWI,iw,MNWMAX,GWTUNIT
      DOUBLE PRECISION MNWILST,MNW2,MNWO
      CHARACTER*20 WELLID,SITE,MNWIID,MSITE
      DIMENSION mnw2(32,mNWMAX),WELLID(MNWMAX),
...
c     ------------------------------------------------------------------
     ...
     & MNWILST,QBH,small,cnode,concw,verysmall,MNWO
      ...
      DIMENSION mnw2(32,mNWMAX),mnwnod(33,NODTOT),WELLID(MNWMAX),

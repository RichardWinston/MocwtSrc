C     Last change: RBW Nov. 21, 2016
C     Support for weighted particles (MOCWT) added.
C  MAIN PROGRAM CONTROL FOR 21GWT (MOC3D) SUBROUTINES
C
C*************************************************************************
...
C  
     ...
     *          BOTM,NBOTM,IUNIT(58),MNWO,NMNWVL)
            ELSE
	         SOLMNW=0.0
            END IF
cellam
...
cgzh ptob
     ...
     *     NUMPTOB,NUMPTOB_MNW,
     *     IPTOBMNW,PTWT,SUMWT, SNKMNW,MNWMAX,MNW2,MNWNOD, NODTOT,
     *     NMNWVL)
CMOCWT
...
c rbw mnw2     
     *      IUNIT(57),MNWMAX,MNW2, MNWNOD, NODTOT,NMNWVL,
cgzh srcfix

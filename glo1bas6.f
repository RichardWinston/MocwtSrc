...
C  Open all files in name file
     ...
     &                 VERSION,INBAS)
C Write USGS software disclaimer to the screen and the listing file.      
      CALL SGLO1BAS6Disclaimer(IOUTG,IOUT)
C
...
C
      END
C=======================================================================
      SUBROUTINE SGLO1BAS6Disclaimer(IOUTG,IOUT)
C Write USGS software disclaimer to the screen and the listing file.  
      CHARACTER(LEN=*), PARAMETER :: Disclaimer =
     * "(/,
     ...
     *  'analysis and review. No warranty, expressed or implied, is ',/,
     ...
     *  'unauthorized use.',/)"
      ...
      Write(*, Disclaimer)
      Write(IOUT, Disclaimer) 
      if (IOUT.NE.IOUTG) Write(IOUTG, Disclaimer)  
      RETURN
      END;
C=======================================================================

...
C
     ...
     *                  MNWOBS,mnwmax,
     *                  IOUT,IOUTS,INMNWO,INMNW2)    
C
C     ******************************************************************
C
      IF(INMNWO.GT.0.AND.INMNW2.LE.0) THEN
...
C
     ...
     *                  IOUTS,INMNWO,
     *                  mnw2,WELLID,mnwmax,nwell2,MNWO,
     *                  NMNWVL)
C
C     ******************************************************************
C
...
C
      ...
      DIMENSION MNWO(mnwmax,7)               
!      dimension well2(18,mnwmax)
      dimension WELLID(mnwmax)
      character*20 WELLID,MNWOLST
...
C     *************************************************************
     ...
     *                IMOV,mnw2,WELLID,mnwmax,nwell2,CWELL,MNWO,
     *                IQzero,KSTP,KPER, NMNWVL)
C     ***************************************************************
      CHARACTER*50  LFRMAT
C
...
C   7: been active before? 0=false 1=true (for header print)
      ...
      DIMENSION MNWUNIT(MNWOBS,2)               
      dimension WELLID(mnwmax)
      dimension IQzero(mnwmax)
      dimension CWELL(mnwmax)
      dimension MNWO(mnwmax,7)
      dimension mnw2(NMNWVL,mnwmax)
      character*20 WELLID,MNWOLST
      CHARACTER*20 SITE,MSITE
...
cljk        ALLOCATE (CONCMNW(mnwmax,7),mmap(mnwmax,2),mnwsingle(mnwmax)) 
      ALLOCATE (CONCMNW(mnwmax,7),mmap(mnwmax,3),mnwsingle(mnwmax)) 
      mnwsingle=0 
